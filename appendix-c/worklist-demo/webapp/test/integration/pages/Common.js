sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("sapui5/demo/worklist/app", ".html");
		...
		return Opa5.extend("sapui5.demo.worklist.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["sapui5/demo/worklist/localService/mockserver"], function (mockserver) {
