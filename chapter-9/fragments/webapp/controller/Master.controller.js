sap.ui.define([
	"sapui5/demo/fragments/controller/BaseController",
	"sap/m/MessageToast",
	"sap/m/MessageBox",
	...
	return BaseController.extend("sapui5.demo.fragments.controller.Master", {
		...
		_showEdit: function(){
		    if (!this._editFragment){
                this._editFragment = sap.ui.xmlfragment("sapui5.demo.fragments.view.EditSupplier");
		      }
		...
		_showDisplay: function(){
	      if (!this._displayFragment){
	          this._displayFragment = sap.ui.xmlfragment("sapui5.demo.fragments.view.DisplaySupplier");
	      }
	      this._supplierPanel.removeAllContent();
