sap.ui.define([
		"sapui5/demo/db/sort/controller/BaseController",
		"sapui5/demo/db/sort/model/formatter",
		"sapui5/demo/db/sort/model/types"
	], function (BaseController, formatter, types) {
	"use strict";
	return BaseController.extend("sapui5.demo.db.sort.controller.Detail", {
