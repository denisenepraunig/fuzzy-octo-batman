sap.ui.define([
		"sapui5/demo/db/calc2/controller/BaseController",
		"sapui5/demo/db/calc2/model/formatter",
		"sapui5/demo/db/calc2/model/types"
	], function (BaseController, formatter, types) {
	"use strict";
	return BaseController.extend("sapui5.demo.db.calc2.controller.Detail", {
