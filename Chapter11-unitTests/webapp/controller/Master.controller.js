sap.ui.define([
	"sapui5/demo/advanced/testing/controller/BaseController",
	"sap/m/MessageToast",
	"sap/m/MessageBox",
	...
	return BaseController.extend("sapui5.demo.advanced.testing.controller.Master", {
		...
		_showEdit: function(){
		    if (!this._editFragment){
                this._editFragment = sap.ui.xmlfragment("sapui5.demo.advanced.testing.view.EditSupplier");
		      }
		...
		_showDisplay: function(){
	      if (!this._displayFragment){
	          this._displayFragment = sap.ui.xmlfragment("sapui5.demo.advanced.testing.view.DisplaySupplier");
	      }
	      this._supplierPanel.removeAllContent();
