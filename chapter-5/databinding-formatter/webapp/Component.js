sap.ui.define([
	...
	return UIComponent.extend("sapui5.demo.db.format.Component", {

		metadata : {
			"rootView": "sapui5.demo.db.format.view.App",
			"dependencies": {
			...
			"config": {
				"i18nBundle": "sapui5.demo.db.format.i18n.i18n",
			...
			"routing": {
				"config": {
					...
					"viewType": "XML",
					"viewPath": "sapui5.demo.db.format.view",
					"controlId": "app",
